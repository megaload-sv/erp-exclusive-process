...
<section class="content-panel">
    <div class="section-heading">
        <div>
            ...
            <p>Inspección visible de componentes, comportamientos y tipos semánticos.</p>
        </div>
...
<section class="content-panel">
    <div class="section-heading"><div>
        ...
        <p>Los descriptores exponen propiedades con tipos semánticos estables.</p>
    </div></div>
        ...
        <details class="developer-component" open>
            ...
            <div class="developer-properties">
                <?php foreach (($metadata['properties'] ?? []) as $property): ?>
                    <div><strong><?= esc($property['label'] ?? $property['name']) ?></strong><code><?= esc($property['type']) ?></code><small><?= ! empty($property['required']) ? 'Required' : 'Optional' ?></small></div>
                <?php endforeach ?>
            </div>
